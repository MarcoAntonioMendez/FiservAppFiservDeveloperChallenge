...
/**
 * The MyScheduledPaymentActivity class will display user's scheduled recurring payments.
 *
 *
...
public class MyScheduledPaymentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_scheduled_payments);
